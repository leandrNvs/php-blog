...
CREATE TABLE `post` (
  `idpost` smallint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `user_favorites` (
  ...
  CONSTRAINT `fk_user_has_post_post1` FOREIGN KEY (`idpost`) REFERENCES `post` (`idpost`) ON DELETE CASCADE,
  CONSTRAINT `fk_user_has_post_user1` FOREIGN KEY (`iduser`) REFERENCES `user` (`iduser`) ON DELETE CASCADE
...
-- Dump completed on 2023-07-26 21:57:23
